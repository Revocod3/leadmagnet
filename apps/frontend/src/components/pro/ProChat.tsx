  ...
  return (
    <>
      ...
      <div className={`${isDarkMode ? 'dark' : ''} flex h-screen overflow-hidden`}>
        ...
        {/* Main Chat Area - Dark Backdrop with Pattern */}
        <div className="flex-1 flex flex-col min-w-0 relative bg-chat-lighting sm:items-center sm:justify-center">
          ...
          <div className="w-full h-full sm:max-w-3xl sm:h-full relative bg-brand-cream-100 dark:bg-neutral-900 bg-chat-lighting shadow-2xl overflow-hidden flex flex-col sm:rounded-2xl sm:border sm:border-white/10 transition-all duration-300 z-10">
            ...
            <div
              ...
              className="mobile-chat-container flex-1 flex flex-col overflow-hidden"
              style={{
